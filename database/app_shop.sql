...
--
-- Host: localhost    Database: app_shop
-- ------------------------------------------------------
...
INSERT INTO `fa_admin` VALUES (1,'admin','Admin','3080b2daee6d3034d15d10a92788c891','4176f8','/assets/img/avatar.png','admin@admin.com','',0,1767492401,'183.251.170.143',1491635035,1767492401,'79835f5a-69de-4705-969d-496e6b54b8d8','normal');
...
CREATE TABLE `fa_auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=404 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='节点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_command` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `type` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '类型',
  `params` varchar(1500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '参数',
  `command` varchar(1500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '命令',
  `content` text COLLATE utf8mb4_general_ci COMMENT '返回结果',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='在线命令表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_jobs` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='队列';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_activity_gift_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `activity_id` int NOT NULL DEFAULT '0' COMMENT '活动',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='满赠记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_activity_groupon` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL DEFAULT '0' COMMENT '团长',
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '商品',
  `activity_id` int NOT NULL DEFAULT '0' COMMENT '活动',
  `num` int NOT NULL DEFAULT '0' COMMENT '成团人数',
  ...
  `finish_time` bigint DEFAULT NULL COMMENT '成团时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='拼团';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_activity_groupon_log` (
  ...
  `groupon_id` int NOT NULL DEFAULT '0' COMMENT '团',
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '商品',
  `goods_sku_price_id` int NOT NULL DEFAULT '0' COMMENT '商品规格',
  `activity_id` int NOT NULL DEFAULT '0' COMMENT '活动',
  `is_leader` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否团长:0=不是,1=是',
  `is_fictitious` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否虚拟:0=不是,1=是',
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `is_refund` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否退款:0=不是,1=是',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `groupon_id` (`groupon_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='参团记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_activity_order` (
  ...
  KEY `order_id` (`order_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='活动订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_activity_signin` (
  ...
  `score` int NOT NULL DEFAULT '0' COMMENT '所得积分',
  `is_replenish` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否补签:0=正常,1=补签',
...
CREATE TABLE `fa_cus_activity_sku_price` (
  `id` int NOT NULL AUTO_INCREMENT,
  `activity_id` int NOT NULL DEFAULT '0' COMMENT '活动',
  `goods_sku_price_id` int NOT NULL DEFAULT '0' COMMENT '规格',
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '商品',
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='活动规格价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_category` (
  ...
  `parent_id` int NOT NULL DEFAULT '0' COMMENT '所属分类',
...
CREATE TABLE `fa_cus_chat_customer_service` (
  ...
  `max_num` int NOT NULL DEFAULT '10' COMMENT '最大接待人数',
  `last_time` bigint DEFAULT NULL COMMENT '上次服务时间',
  `status` enum('offline','online','busy') NOT NULL DEFAULT 'offline' COMMENT '状态',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='chat客服';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_chat_customer_service_user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_service_id` int NOT NULL DEFAULT '0' COMMENT '客服',
  `auth` varchar(60) DEFAULT NULL COMMENT '认证类型',
  `auth_id` int NOT NULL DEFAULT '0' COMMENT '认证用户',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `customer_service_id` (`customer_service_id`) USING BTREE,
  KEY `auth` (`auth`,`auth_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='客服用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_chat_question` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `room_id` (`room_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='猜你想问';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_chat_record` (
  `id` int NOT NULL AUTO_INCREMENT,
  `chat_user_id` int NOT NULL DEFAULT '0' COMMENT '顾客',
  `room_id` varchar(60) NOT NULL DEFAULT 'admin' COMMENT '房间号',
  `sender_identify` enum('customer_service','customer') NOT NULL DEFAULT 'customer' COMMENT '发送身份',
  `sender_id` int NOT NULL DEFAULT '0' COMMENT '发送者',
...
CREATE TABLE `fa_cus_chat_service_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `chat_user_id` int NOT NULL DEFAULT '0' COMMENT 'chat user',
  `customer_service_id` int NOT NULL DEFAULT '0' COMMENT '客服',
  `room_id` varchar(60) NOT NULL DEFAULT 'admin' COMMENT '房间号',
  ...
  KEY `chat_user_id` (`chat_user_id`) USING BTREE,
  KEY `customer_service_id` (`customer_service_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='chat服务记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_chat_user` (
  ...
  `customer_service_id` int NOT NULL DEFAULT '0' COMMENT '最后接待客服',
  `last_time` bigint DEFAULT NULL COMMENT '上次在线时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `session_id` (`session_id`) USING BTREE,
  KEY `auth` (`auth`,`auth_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='chat用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_agent` (
  ...
  `level` int NOT NULL COMMENT '分销商等级',
  ...
  `child_order_count_0` int NOT NULL DEFAULT '0' COMMENT '自购/直推分销订单数量',
  `child_order_count_1` int NOT NULL DEFAULT '0' COMMENT '一级分销订单数量',
  `child_order_count_2` int NOT NULL DEFAULT '0' COMMENT '二级分销订单数量',
  `child_order_count_all` int NOT NULL DEFAULT '0' COMMENT '团队分销订单数量',
  `child_agent_count_1` int NOT NULL DEFAULT '0' COMMENT '直推分销商人数',
  `child_agent_count_2` int NOT NULL DEFAULT '0' COMMENT '二级分销商人数',
  `child_agent_count_all` int NOT NULL DEFAULT '0' COMMENT '团队分销商人数',
  `child_agent_level_1` varchar(255) DEFAULT '' COMMENT '一级分销商等级统计',
  `child_agent_level_all` varchar(255) DEFAULT '' COMMENT '团队分销商等级统计',
  `child_user_count_1` int NOT NULL DEFAULT '0' COMMENT '一级用户人数',
  `child_user_count_2` int NOT NULL DEFAULT '0' COMMENT '二级用户人数',
  `child_user_count_all` int NOT NULL DEFAULT '0' COMMENT '团队用户人数',
  `upgrade_lock` tinyint NOT NULL DEFAULT '0' COMMENT '升级锁定:0=不锁定,1=锁定',
  `apply_num` int NOT NULL DEFAULT '0' COMMENT '提交申请次数',
  `level_status` tinyint NOT NULL DEFAULT '0' COMMENT '升级状态:0=不升级,>1=待升级等级',
  `status` varchar(20) NOT NULL DEFAULT 'normal' COMMENT '分销商状态:forbidden=禁用,pending=审核中,freeze=冻结,normal=正常,reject=拒绝',
  `become_time` bigint DEFAULT NULL COMMENT '成为分销商时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销商';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_goods` (
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '分销商品',
  `self_rules` tinyint DEFAULT '0' COMMENT '独立设置佣金:0=否,1=是',
  `commission_rules` text COMMENT '佣金设置',
  `status` tinyint NOT NULL COMMENT '状态:0=不参与分销,1=参与分销',
  `commission_config` text COMMENT '独立佣金规则',
  `commission_order_status` tinyint NOT NULL DEFAULT '1' COMMENT '是否计入业绩:0=否,1=是',
  PRIMARY KEY (`goods_id`) USING BTREE,
  UNIQUE KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销商品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_level` (
  `level` int NOT NULL COMMENT '权重等级',
  `name` varchar(50) NOT NULL COMMENT '等级名称',
  `image` varchar(255) DEFAULT NULL COMMENT '等级徽章',
  `commission_rules` text NOT NULL COMMENT '佣金比例设置',
  `upgrade_type` tinyint NOT NULL DEFAULT '0' COMMENT '升级方式',
  `upgrade_rules` text COMMENT '升级规则',
  PRIMARY KEY (`level`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销商等级';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `agent_id` int NOT NULL DEFAULT '0' COMMENT '分销商',
  ...
  `oper_id` int NOT NULL DEFAULT '0' COMMENT '操作人ID',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `agent_id` (`agent_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销动态日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_order` (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `self_buy` tinyint NOT NULL DEFAULT '0' COMMENT '是否分销内购:0=分销订单,1=内购订单',
  `order_item_id` int NOT NULL DEFAULT '0' COMMENT '订单商品',
  `buyer_id` int NOT NULL DEFAULT '0' COMMENT '购买人',
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '商品',
  `agent_id` int NOT NULL DEFAULT '0' COMMENT '分销商',
  ...
  `commission_order_status` tinyint NOT NULL DEFAULT '0' COMMENT '分销商业绩:-2=已扣除,-1=已取消,0=不计入,1=已计入',
  `commission_reward_status` tinyint NOT NULL DEFAULT '0' COMMENT '佣金处理状态:-2=已退回,-1=已取消,0=未结算,1=已结算',
  `commission_rules` text COMMENT '执行佣金结算规则',
  `commission_time` bigint DEFAULT NULL COMMENT '结算时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `order_id` (`order_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_commission_reward` (
  ...
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `order_item_id` int NOT NULL DEFAULT '0' COMMENT '订单商品',
  `commission_order_id` int NOT NULL DEFAULT '0' COMMENT '分销订单',
  ...
  `commission_level` tinyint NOT NULL DEFAULT '0' COMMENT '执行层级',
  `agent_level` int NOT NULL DEFAULT '0' COMMENT '执行等级',
  `commission_rules` varchar(255) DEFAULT NULL COMMENT '执行规则',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态:-2=已退回,-1=已取消,0=待入账,1=已入账',
  `commission_time` bigint DEFAULT NULL COMMENT '结算时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  KEY `agent_id` (`agent_id`) USING BTREE,
  KEY `buyer_id` (`buyer_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='分销佣金';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_config` (
  ...
  `weigh` int NOT NULL DEFAULT '50' COMMENT '权重',
...
CREATE TABLE `fa_cus_coupon` (
  ...
  `get_start_time` bigint NOT NULL DEFAULT '0' COMMENT '领取开始时间',
  `get_end_time` bigint NOT NULL DEFAULT '0' COMMENT '领取结束时间',
  `use_time_type` enum('range','days') NOT NULL DEFAULT 'range' COMMENT '使用时间类型:range=固定区间,days=相对天数',
  `use_start_time` bigint NOT NULL DEFAULT '0' COMMENT '使用开始时间',
  `use_end_time` bigint NOT NULL DEFAULT '0' COMMENT '使用结束时间',
  `start_days` int NOT NULL DEFAULT '0' COMMENT '开始有效天数',
  `days` int NOT NULL DEFAULT '0' COMMENT '有效天数',
  `is_double_discount` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '优惠叠加:0=不可叠加,1=可叠加',
...
CREATE TABLE `fa_cus_data_area` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=713207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='地区';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='快递公司';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_data_fake_user` (
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='虚拟用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_data_page` (
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='前端路由';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_data_richtext` (
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='富文本';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_decorate` (
  ...
  `deletetime` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='装修模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_decorate_page` (
  `id` int NOT NULL AUTO_INCREMENT,
  `decorate_id` int NOT NULL DEFAULT '0' COMMENT '模板',
  `type` varchar(10) NOT NULL COMMENT '类型',
  `page` longtext NOT NULL COMMENT '数据',
  `image` longtext COMMENT '截图',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模板数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_dispatch` (
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='发货模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_dispatch_autosend` (
  `id` int NOT NULL AUTO_INCREMENT,
  `dispatch_id` int NOT NULL COMMENT '配送模板',
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='自动发货';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_dispatch_express` (
  `id` int NOT NULL AUTO_INCREMENT,
  `dispatch_id` int NOT NULL DEFAULT '0' COMMENT '配送模板',
  `type` enum('number','weight') NOT NULL DEFAULT 'number' COMMENT '计费方式:number=件数,weight=重量',
  `first_num` int NOT NULL DEFAULT '0' COMMENT '首(重/件)数',
  `first_price` decimal(10,2) DEFAULT NULL COMMENT '首(重/件)',
  `additional_num` int NOT NULL DEFAULT '0' COMMENT '续(重/件)数',
...
CREATE TABLE `fa_cus_feedback` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL DEFAULT '0' COMMENT '反馈用户',
...
CREATE TABLE `fa_cus_goods` (
  ...
  `show_sales` int NOT NULL DEFAULT '0' COMMENT '显示销量',
  `service_ids` varchar(120) DEFAULT NULL COMMENT '服务标签',
  `dispatch_type` varchar(120) DEFAULT NULL COMMENT '发货方式',
  `dispatch_id` int NOT NULL DEFAULT '0' COMMENT '发货模板',
  `is_offline` tinyint NOT NULL DEFAULT '0' COMMENT '线下付款:0=否,1=是',
...
CREATE TABLE `fa_cus_goods_comment` (
  ...
  `level` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '评价星级',
  ...
  `reply_time` bigint DEFAULT NULL COMMENT '回复时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  `deletetime` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `fa_cus_goods_service` (
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品服务标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_goods_sku` (
  ...
  `parent_id` int NOT NULL DEFAULT '0' COMMENT '所属规格',
  `goods_id` int NOT NULL DEFAULT '0' COMMENT '商品',
  `weigh` int NOT NULL DEFAULT '0' COMMENT '权重',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `fa_cus_goods_sku_price` (
  ...
  `stock` int NOT NULL DEFAULT '0' COMMENT '库存',
  `stock_warning` int DEFAULT NULL COMMENT '库存预警',
  `sales` int NOT NULL DEFAULT '0' COMMENT '销量',
  ...
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品规格价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_goods_stock_log` (
  ...
  `before` int NOT NULL DEFAULT '0' COMMENT '补货前',
  `stock` int NOT NULL DEFAULT '0' COMMENT '补货库存',
  `msg` varchar(255) DEFAULT NULL COMMENT '补货备注',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品库存记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_goods_stock_warning` (
  ...
  `goods_sku_price_id` int NOT NULL DEFAULT '0' COMMENT '规格',
  `goods_sku_text` varchar(255) DEFAULT NULL COMMENT '规格名',
  `stock_warning` int NOT NULL DEFAULT '0' COMMENT '预警值',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  `deletetime` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品库存预警';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_mplive_goods` (
  `id` int NOT NULL,
  `type` tinyint DEFAULT NULL COMMENT '商品来源',
  `audit_id` int DEFAULT NULL COMMENT '审核单ID',
  `goods_id` int DEFAULT NULL COMMENT '商城商品ID',
  `name` varchar(255) DEFAULT NULL COMMENT '商品名称',
  `cover_img_url` varchar(255) DEFAULT NULL COMMENT '封面图',
  `price_type` tinyint DEFAULT NULL COMMENT '价格类型',
  `price` decimal(10,2) DEFAULT NULL COMMENT '价格',
  `price2` decimal(10,2) DEFAULT NULL COMMENT '价格2',
  `third_party_tag` tinyint DEFAULT NULL COMMENT '添加商品标识',
  `third_party_appid` varchar(255) DEFAULT NULL COMMENT '第三方小程序APPID',
  `on_shelves` tinyint DEFAULT NULL COMMENT '上架状态',
  `audit_status` tinyint DEFAULT NULL COMMENT '审核状态',
  `url` varchar(255) DEFAULT NULL COMMENT '商品链接',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='直播间商品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_mplive_room` (
  `roomid` int NOT NULL COMMENT '房间号',
  `name` varchar(255) DEFAULT NULL COMMENT '直播间名称',
  `type` tinyint DEFAULT NULL COMMENT '直播方式',
  `status` int DEFAULT NULL COMMENT '状态',
  `is_feeds_public` tinyint DEFAULT NULL COMMENT '官方推荐',
  ...
  `close_replay` tinyint DEFAULT NULL COMMENT '关闭回放',
  `close_like` tinyint DEFAULT NULL COMMENT '关闭点赞',
  `close_kf` tinyint DEFAULT NULL COMMENT '关闭客服',
  `close_goods` tinyint DEFAULT NULL COMMENT '关闭商品橱窗',
  `close_comment` tinyint DEFAULT NULL COMMENT '关闭评论',
...
CREATE TABLE `fa_cus_notification` (
  ...
  `notifiable_id` int NOT NULL DEFAULT '0' COMMENT '通知人',
...
CREATE TABLE `fa_cus_notification_config` (
  ...
  `send_num` int NOT NULL DEFAULT '0' COMMENT '发送次数',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `fa_cus_order` (
  ...
  `score_amount` int NOT NULL DEFAULT '0' COMMENT '积分总数',
  ...
  `paid_time` bigint DEFAULT NULL COMMENT '支付成功时间',
  `pay_mode` enum('online','offline') NOT NULL DEFAULT 'online' COMMENT '支付模式:online=线上支付,offline=线下支付',
  `apply_refund_status` tinyint NOT NULL DEFAULT '0' COMMENT '申请退款状态:0=未申请,1=用户申请退款,-1=拒绝申请',
  ...
  `coupon_id` int NOT NULL DEFAULT '0' COMMENT '优惠券',
  `invoice_status` tinyint NOT NULL DEFAULT '0' COMMENT '发票开具状态:-1=不可开具,0=未申请,1=已申请',
  `ext` varchar(2048) DEFAULT NULL COMMENT '附加信息',
...
CREATE TABLE `fa_cus_order_action` (
  ...
  `oper_id` int NOT NULL DEFAULT '0' COMMENT '操作人',
  ...
  `dispatch_status` tinyint NOT NULL DEFAULT '0' COMMENT '发货状态:-1=拒收,0=未发货,1=已发货,2=已收货',
  `aftersale_status` tinyint NOT NULL DEFAULT '0' COMMENT '售后状态:-1=拒绝,0=未申请,1=申请售后,2=售后完成',
  `refund_status` tinyint NOT NULL DEFAULT '0' COMMENT '退款状态:0=未退款,1=已同意,2=已完成',
  ...
  KEY `order_id` (`order_id`) USING BTREE,
  KEY `order_item_id` (`order_item_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单操作';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_order_address` (
  ...
  `district_id` int NOT NULL DEFAULT '0' COMMENT '区Id',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `order_id` (`order_id`) USING BTREE
...
CREATE TABLE `fa_cus_order_aftersale` (
  ...
  `goods_num` int NOT NULL DEFAULT '0' COMMENT '购买数量',
  `dispatch_status` tinyint NOT NULL DEFAULT '0' COMMENT '发货状态:-1=拒收,0=未发货,1=已发货,2=已收货',
  `dispatch_fee` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '发货费用',
  `aftersale_status` tinyint NOT NULL DEFAULT '0' COMMENT '售后状态:-2=已取消,-1=拒绝,0=未处理,1=申请售后,2=售后完成',
  `refund_status` tinyint NOT NULL DEFAULT '0' COMMENT '退款状态:0=未退款,1=已同意',
...
CREATE TABLE `fa_cus_order_aftersale_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `order_aftersale_id` int NOT NULL DEFAULT '0' COMMENT '售后单',
  `oper_type` varchar(60) DEFAULT NULL COMMENT '操作人类型',
  `oper_id` int NOT NULL DEFAULT '0' COMMENT '操作人',
  `dispatch_status` tinyint NOT NULL DEFAULT '0' COMMENT '发货状态:-1=拒收,0=未发货,1=已发货,2=已收货',
  `aftersale_status` tinyint NOT NULL DEFAULT '0' COMMENT '售后状态:-1=拒绝,0=未申请,1=申请售后,2=售后完成',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单售后记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_order_express` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='快递包裹';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_order_express_log` (
  ...
  `user_id` int NOT NULL DEFAULT '0' COMMENT '用户',
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `order_express_id` int NOT NULL DEFAULT '0' COMMENT '快递包裹',
...
CREATE TABLE `fa_cus_order_invoice` (
  ...
  `finish_time` bigint NOT NULL DEFAULT '0' COMMENT '开具时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
...
CREATE TABLE `fa_cus_order_item` (
  ...
  `activity_type` varchar(255) DEFAULT NULL COMMENT '活动类型',
  `promo_types` varchar(255) DEFAULT NULL COMMENT '营销类型',
  `item_goods_sku_price_id` int NOT NULL DEFAULT '0' COMMENT '活动规格|积分商城规格',
  `goods_sku_text` varchar(60) DEFAULT NULL COMMENT '规格名',
...
CREATE TABLE `fa_cus_pay` (
  ...
  `paid_time` bigint DEFAULT NULL COMMENT '交易时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='支付配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_refund` (
  ...
  `order_id` int NOT NULL DEFAULT '0' COMMENT '订单',
  `pay_id` int NOT NULL DEFAULT '0' COMMENT '支付',
  `pay_type` enum('wechat','alipay','money','score','offline') DEFAULT NULL COMMENT '支付方式:wechat=微信支付,alipay=支付宝,money=钱包支付,score=积分支付,offline=线下支付',
  `refund_fee` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '退款金额',
  ...
  KEY `order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='退款';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_score_sku_price` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='积分商城';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_share` (
  ...
  `user_id` int NOT NULL DEFAULT '0' COMMENT '用户',
  `share_id` int NOT NULL DEFAULT '0' COMMENT '分享人',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户分享记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_third_oauth` (
  ...
  `avatar` varchar(255) DEFAULT NULL COMMENT '头像',
  `login_num` int NOT NULL DEFAULT '0' COMMENT '使用登录次数',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`,`openid`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='第三方用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_user_address` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL DEFAULT '0' COMMENT '用户',
  `is_default` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '默认:0=否,1=是',
  `consignee` varchar(60) DEFAULT NULL COMMENT '收货人',
  `mobile` varchar(20) DEFAULT NULL COMMENT '收货手机',
  `province_name` varchar(60) DEFAULT NULL COMMENT '省份',
  `city_name` varchar(60) DEFAULT NULL COMMENT '城市',
...
CREATE TABLE `fa_cus_user_coupon` (
  ...
  `user_id` int NOT NULL DEFAULT '0' COMMENT '用户',
  `coupon_id` int NOT NULL DEFAULT '0' COMMENT '优惠券',
  `use_order_id` int NOT NULL DEFAULT '0' COMMENT '使用订单',
...
CREATE TABLE `fa_cus_user_invoice` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='我的发票';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_user_wallet_log` (
  ...
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户资金日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_wechat_material` (
  ...
  `deletetime` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='素材管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_wechat_menu` (
  ...
  `status` int NOT NULL DEFAULT '0' COMMENT '状态:0=未发布,1=已发布',
  `publishtime` bigint DEFAULT NULL COMMENT '发布时间',
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='微信公众号菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_wechat_reply` (
  ...
  `deletetime` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='自动回复';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_withdraw` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL DEFAULT '0' COMMENT '提现用户',
  ...
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '提现状态:-3=撤销提现,-2=提现失败,-1=已拒绝,0=待审核,1=处理中,2=已处理',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户提现';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_cus_withdraw_log` (
  ...
  `createtime` bigint DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='提现日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_user` (
  ...
  `parent_user_id` int DEFAULT NULL COMMENT '上级用户',
...
INSERT INTO `fa_user` VALUES (1,1,'admin','admin','afa2e330e21c08589504636749e7b527','fa7d6c','admin@163.com','13000000000','/assets/img/avatar.png',0,0,'2017-04-08','',0.00,0.00,0,1,1,1491635035,1491635035,'127.0.0.1',0,1491635035,'127.0.0.1',1491635035,0,1491635035,'','normal','',NULL,0.00);
...
--
-- Dumping events for database 'app_shop'
--

--
-- Dumping routines for database 'app_shop'
--
...
-- Dump completed on 2026-01-04 10:08:36
