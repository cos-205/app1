                ...
                setup() {
                    ...
                    function onBatchHandle(type) {
                        ...
                        switch (type) {
                            ...
                            default:
                                Fast.api.ajax({
                                    url: `cus/feedback/edit/id/${ids.join(',')}`,
                                    type: 'POST',
                                    data: {
                                        status: type
                                    }
                    ...
                    function onDetail(id) {
                        Fast.api.open(`cus/feedback/detail?type=edit&id=${id}`, "编辑", {
                            callback() {
                                getData()
                            }
                        })
        ...
        detail: () => {
            ...
            const detail = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/feedback/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            form.model = res.data;
                            return false
                    ...
                    function onConfirm() {
                        proxy.$refs['formRef'].validate((valid) => {
                            if (valid) {
                                Fast.api.ajax({
                                    url: `cus/feedback/edit/id/${state.id}`,
                                    type: 'POST',
                                    data: {
