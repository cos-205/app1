                ...
                cloneComponent: (type, theme = 'orange') => {
                    let comp = {
                        ...
                        noticeBlock: {
                            ...
                            data: {
                                mode: 1,
                                src: '/assets/addons/cus/img/decorate/notice/1.png',
                                title: {
                                    text: '',
                                    color: '#111111',
                                },
                        ...
                        titleBlock: {
                            type: 'titleBlock',
                            data: {
                                src: '/assets/addons/cus/img/decorate/title/1.png',
                    ...
                    data.data.forEach((t) => {
                        if (['goodsCard', 'goodsShelves'].includes(t.type)) {
                            ...
                            if (t.data.activityId) {
                                Fast.api.ajax({
                                    url: `cus/activity/activity/detail/id/${t.data.activityId}`,
                                    type: 'GET',
                                }, function (ret, res) {
                                    t.data.activityList = [res.data];
                                    Fast.api.ajax({
                                        url: 'cus/goods/goods/activitySelect',
                                        type: 'GET',
                                        data: {
                            ...
                            Fast.api.ajax({
                                url: 'cus/app/mplive/room/select',
                                type: 'GET',
                                data: {
                                    type: 'select',
            ...
            const index = {
                setup() {
                    ...
                    const rightData = reactive({
                        ...
                        activeTab: 'data',
                        noticeList: [
                            '/assets/addons/cus/img/decorate/notice/1.png',
                            '/assets/addons/cus/img/decorate/notice/2.png',
                            '/assets/addons/cus/img/decorate/notice/3.png'
                        ],
                    })
                    ...
                    const titleBlockDialog = reactive({
                        visible: false,
                        titleList: [
                            '/assets/addons/cus/img/decorate/title/1.png'
                        ],
                        active: '/assets/addons/cus/img/decorate/title/1.png'
                    })
                    ...
                    function onSelectRichtext() {
                        Fast.api.open('cus/data/richtext/select', "选择富文本", {
                            callback: function (data) {
                    ...
                    function onSelectGroupon() {
                        Fast.api.open('cus/activity/activity/select?type=groupon,groupon_ladder', "选择拼团活动", {
                            callback: function (data) {
                    ...
                    function onSelectSeckill() {
                        Fast.api.open('cus/activity/activity/select?type=seckill', "选择秒杀活动", {
                            callback: function (data) {
                                currentComp.right.data.activityList = [data];
                                Fast.api.ajax({
                                    url: 'cus/goods/goods/activitySelect',
                    ...
                    function onSelectScoreGoods() {
                        Fast.api.open('cus/app/score_shop/select?multiple=true', "选择积分商品", {
                            callback: function (data) {
                    ...
                    function onSelectCoupon() {
                        Fast.api.open('cus/coupon/select?multiple=true&status=normal', "选择优惠券", {
                            callback: function (data) {
                    ...
                    function getTemplateDetail() {
                        Fast.api.ajax({
                            url: `cus/decorate/template/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    function getData() {
                        Fast.api.ajax({
                            url: `cus/decorate/page/detail/id/${state.id}`,
                            type: 'GET',
                            data: {
                                type: state.pageType
                            }
                        ...
                        return new Promise((resolve) => {
                            nextTick(() => {
                                html2canvas(document.getElementById('html2canvasWrap'), {
                                    ...
                                    formData.append('cus_type', 'simple');
                                    $.ajax({
                                        type: "POST",
                                        url: "ajax/upload",
                                        data: formData,
                    ...
                    async function onSave() {
                        ...
                        Fast.api.ajax({
                            url: `cus/decorate/page/edit/id/${state.id}`,
                            type: 'POST',
                            data: {
                                type: state.pageType,
                    ...
                    function onPreview() {
                        ...
                        Fast.api.open(`cus/decorate/page/preview`, "预览")
                    }
                    ...
                    const urlData = computed(() => {
                        ...
                        if (state.detail.type == 'designer') {
                            ...
                            obj = {
                                ...
                                WechatMiniProgram: `${window.location.origin}/addons/cus/third.wechat/wxacode?platform=miniProgram&payload=${encodeURIComponent(
                                    JSON.stringify({
