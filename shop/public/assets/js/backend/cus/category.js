        ...
        index: () => {
            ...
            const index = {
                setup() {
                    ...
                    function onEdit(id) {
                        Fast.api.open(`cus/category/edit?type=edit&id=${id}`, "编辑", {
                            callback() {
                                getData()
                            }
                        })
        ...
        form: () => {
            ...
            const addEdit = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/category/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    function onConfirm() {
                        ...
                        proxy.$refs['formRef'].validate((valid) => {
                            if (valid) {
                                Fast.api.ajax({
                                    url: state.type == 'add' ? 'cus/category/add' : `cus/category/edit/id/${state.id}`,
                                    type: 'POST',
                                    data: submitForm
                                }, function (ret, res) {
                                    Fast.api.close()
