            ...
            const index = {
                setup() {
                    ...
                    function onDetail(id) {
                        Fast.api.open(`cus/activity/groupon/detail/id/${id}?id=${id}`, "详情", {
                            callback() {
                                getData()
                            }
                        })
        ...
        detail: () => {
            ...
            const detail = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/activity/groupon/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            state.data = res.data
                            return false
                    ...
                    function onInvalid() {
                        Fast.api.ajax({
                            url: `cus/activity/groupon/invalid/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            getDetail()
                        }, function (ret, res) { })
                    ...
                    function onAddUser() {
                        Fast.api.ajax({
                            url: 'cus/data/fake_user/getRandom',
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    function onConfirm(item) {
                        Fast.api.ajax({
                            url: `cus/activity/groupon/addUser/id/${state.id}`,
                            type: 'POST',
                            data: {
                                avatar: item.avatar,
