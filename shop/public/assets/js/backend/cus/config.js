            ...
            const index = {
                setup() {
                    ...
                    function getData() {
                        ...
                        if (state.tabActive == 'cus/config/platform') {
                            getPlatformStatus()
                        } else if (state.tabActive == 'cus/pay_config') {
                            getPayConfig()
                        } else {
                            Fast.api.ajax({
                                url: state.tabActive,
                                ...
                                // 用户配置
                                if (state.tabActive == 'cus/config/user') {
                                    getGroupSelect()
                                }

                                if (state.tabActive == 'cus/config/dispatch') {
                                ...
                                if (state.tabActive == 'cus/config/commission') {
                                ...
                                if (state.tabActive == 'cus/config/chat') {
                                    getChatConfig()
                                }
                                return false
                            }, function (ret, res) { })
                    ...
                    function onEditPlatform(item) {
                        Fast.api.open(`cus/config/platform/platform/${item.value}?platform=${item.value}&label=${item.label}`, `平台-${item.label}`, {
                            callback() {
                                getData()
                            }
                        })
                    ...
                    function onCommandPayConfig(item) {
                        Fast.api.ajax({
                            url: `cus/pay_config/edit/id/${item.id}`,
                            type: 'POST',
                            data: {
                                status: item.type
                            }
                    ...
                    function onAddPayConfig() {
                        Fast.api.open('cus/pay_config/add?type=add', "添加", {
                            callback() {
                                getPayConfig()
                            }
                        })
                    ...
                    function onEditPayConfig(id) {
                        Fast.api.open(`cus/pay_config/edit?type=edit&id=${id}`, "编辑", {
                            callback() {
                                getPayConfig()
                            }
                        })
                    ...
                    function onDeletePayConfig(id) {
                        Fast.api.ajax({
                            url: `cus/pay_config/delete/id/${id}`,
                            type: 'DELETE',
                        }, function (ret, res) {
                            getPayConfig()
                        }, function (ret, res) { })
                    ...
                    function onRecyclebinPayConfig() {
                        Fast.api.open(`cus/pay_config/recyclebin`, "回收站", {
                            callback() {
                                getPayConfig()
                            }
                        })
                    ...
                    function onConfirm() {
                        ...
                        if (state.tabActive == 'cus/config/redis') {
                    ...
                    function onOper(type) {
                        switch (type) {
                            ...
                            case 'refresh':
                                ...
                                break;
                            case 'upgrade':
                                window.open("https://www.fastadmin.net/store/cus.html")
                                break;
                        }
                    }
        ...
        platform: () => {
            ...
            const platform = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/config/platform/platform/${state.platform}`,
                            type: 'GET',
                        }, function (ret, res) {
                            form.model = res.data;
