            ...
            const index = {
                setup() {
                    ...
                    function onEdit(ids, rulesType = '') {
                        Fast.api.open(`cus/commission/goods/edit?type=edit&id=${ids}&rulesType=${rulesType}`, "设置佣金", {
                            callback() {
                                getData()
                            }
                        })
        ...
        form: () => {
            ...
            const addEdit = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/commission/goods/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            state.data = res.data;
                    ...
                    function onConfirm() {
                        ...
                        Fast.api.ajax({
                            url: `cus/commission/goods/edit/id/${state.id}`,
                            type: 'POST',
