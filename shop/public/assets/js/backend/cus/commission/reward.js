                ...
                setup() {
                    ...
                    function onExport(type) {
                        ...
                        if (Config.save_type == 'download') {
                            window.location.href = `${Config.moduleurl}/cus/commission/reward/${type}?page=${pagination.page}&list_rows=${pagination.list_rows}&search=${search.search}`;
                            exportLoading.value = false;
                        } else if (Config.save_type == 'save') {
                            Fast.api.ajax({
                                url: `cus/commission/reward/${type}`,
                                type: 'GET',
                                data: {
                                    page: pagination.page,
                                    list_rows: pagination.list_rows,
