            ...
            const index = {
                setup() {
                    ...
                    function onConfirm(data) {
                        Fast.api.ajax({
                            url: 'cus/commission/order/confirm',
                            type: 'POST',
                            data: data,
                        }, function (ret, res) {
                            getData();
                    ...
                    function onCancel(data) {
                        Fast.api.ajax({
                            url: 'cus/commission/order/cancel',
                            type: 'POST',
                            data: data,
                        }, function (ret, res) {
                            getData();
                    ...
                    function onExport(type) {
                        ...
                        if (Config.save_type == 'download') {
                            window.location.href = `${Config.moduleurl}/cus/commission/order/${type}?page=${pagination.page}&list_rows=${pagination.list_rows}&search=${search.search}`;
                            exportLoading.value = false;
                        } else if (Config.save_type == 'save') {
                            Fast.api.ajax({
                                url: `cus/commission/order/${type}`,
                                type: 'GET',
                                data: {
                                    page: pagination.page,
                                    list_rows: pagination.list_rows,
