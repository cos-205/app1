            ...
            const index = {
                setup() {
                    ...
                    function getLevelSelect() {
                        Fast.api.ajax({
                            url: `cus/commission/level/select`,
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    function onEdit(id, data) {
                        Fast.api.ajax({
                            url: `cus/commission/agent/edit/id/${id}`,
                            type: 'POST',
                            data: data,
                        }, function (ret, res) {
                            getData();
                    ...
                    function onDetail(id) {
                        Fast.api.open(`cus/commission/agent/detail/id/${id}?id=${id}`, "详情", {
                            callback() {
                                getData()
                            }
                        })
        ...
        detail: () => {
            ...
            const detail = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/commission/agent/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            state.data = res.data
                    ...
                    function onChangeLevel() {
                        Fast.api.open(`cus/commission/level/select?level=${state.data.level}`, "更换分销等级", {
                            callback(level) {
                                onEdit({ level });
                            }
                        })
                    ...
                    function onChangeParentUser() {
                        Fast.api.open(`cus/commission/agent/select?id=${state.data.user_id}`, "更换上级分销商", {
                            callback() {
                                getDetail()
                            }
                        })
                    ...
                    function onEdit(data) {
                        Fast.api.ajax({
                            url: `cus/commission/agent/edit/id/${state.id}`,
                            type: 'POST',
                            data,
                        }, function (ret, res) {
                            getDetail()
                    ...
                    function onTeam() {
                        Fast.api.open(`cus/commission/agent/team?id=${state.id}`, "查看团队")
                    }
                    ...
                    function getLog() {
                        ...
                        Fast.api.ajax({
                            url: `cus/commission/${log.tabActive}`,
                            type: 'GET',
                            data: {
                                page: pagination.page,
                                list_rows: pagination.list_rows,
            ...
            const select = {
                setup() {
                    ...
                    async function getUserDetail() {
                        Fast.api.ajax({
                            url: `cus/user/user/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                    ...
                    function getData() {
                        ...
                        Fast.api.ajax({
                            url: 'cus/commission/agent/select',
                            type: 'GET',
                            data: {
                                page: pagination.page,
                                list_rows: pagination.list_rows,
                    ...
                    async function onConfirm() {
                        ...
                        Fast.api.ajax({
                            url: `cus/commission/agent/changeParentUser/id/${state.id}`,
                            type: 'POST',
                            data: {
            ...
            const team = {
                setup() {
                    ...
                    async function getTeam(id) {
                        Fast.api.ajax({
                            url: `cus/commission/agent/team/id/${id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            state.data = res.data;
                            return false
