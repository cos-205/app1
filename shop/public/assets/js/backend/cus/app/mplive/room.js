        ...
        form: () => {
            ...
            const addEdit = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/app/mplive/room/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
                            form.model = res.data;
                    ...
                    function onConfirm() {
                        ...
                        Fast.api.ajax({
                            url: state.type == 'add' ? 'cus/app/mplive/room/add' : `cus/app/mplive/room/edit/id/${state.id}`,
                            type: 'POST',
                            data: submitForm,
                        }, function (ret, res) {
                            Fast.api.close()
        ...
        pushurl: () => {
            ...
            const pushUrl = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/app/mplive/room/pushUrl/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
        ...
        qrcode: () => {
            ...
            const qrcode = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/app/mplive/room/qrcode/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
        ...
        playback: () => {
            ...
            const playback = {
                setup() {
                    ...
                    function getData() {
                        Fast.api.ajax({
                            url: `cus/app/mplive/room/playback/id/${state.id}`,
                            type: 'GET',
                            // data: {
