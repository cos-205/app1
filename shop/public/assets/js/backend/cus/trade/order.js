                ...
                setup() {
                    ...
                    function onExport() {
                        ...
                        if (Config.save_type == 'download') {
                            window.location.href = `${Config.moduleurl}/cus/trade/order/export?page=${pagination.page}&list_rows=${pagination.list_rows}&search=${search.search}`;
                            exportLoading.value = false;
                        } else if (Config.save_type == 'save') {
                            Fast.api.ajax({
                                url: 'cus/trade/order/export',
                                type: 'GET',
                                data: {
                                    page: pagination.page,
                                    list_rows: pagination.list_rows,
                    ...
                    function onDetail(id) {
                        Fast.api.open(`cus/trade/order/detail/id/${id}?id=${id}`, "详情", {
                            callback() {
                                getData()
                            }
                        })
        ...
        detail: () => {
            ...
            const detail = {
                setup() {
                    ...
                    function getDetail() {
                        Fast.api.ajax({
                            url: `cus/trade/order/detail/id/${state.id}`,
                            type: 'GET',
                        }, function (ret, res) {
