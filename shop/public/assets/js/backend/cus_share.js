define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'cus_share/index' + location.search,
                    add_url: 'cus_share/add',
                    edit_url: 'cus_share/edit',
                    del_url: 'cus_share/del',
                    multi_url: 'cus_share/multi',
                    import_url: 'cus_share/import',
                    table: 'cus_share',
                }
            });
