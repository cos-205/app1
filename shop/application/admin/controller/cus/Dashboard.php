...
use app\admin\model\cus\Share;
use addons\cus\service\SearchHistory;
...
class Dashboard extends Common
{
    ...
    public function index()
    {
        $cardList = [
            [
                'name' => 'total',
                'card' => 'cus/dashboard/total',
                'status' => $this->auth->check('cus/dashboard/total')
            ],
            [
                'name' => 'chart',
                'card' => 'cus/dashboard/chart',
                'status' => $this->auth->check('cus/dashboard/chart')
            ],
            [
                'name' => 'ranking',
                'card' => 'cus/dashboard/ranking',
                'status' => $this->auth->check('cus/dashboard/ranking')
            ],
        ];
    ...
    public function total()
    {
        ...
        $agentData = [
            'total' => \app\admin\model\cus\commission\Agent::count(),
            'today' => \app\admin\model\cus\commission\Agent::whereTime('createtime', 'today')->count(),
            'week' => \app\admin\model\cus\commission\Agent::whereTime('createtime', 'week')->count(),
            'array' => collection(\app\admin\model\cus\commission\Agent::field('user_id,createtime')->whereTime('createtime', 'today')->select())->each(function ($agent) {
                $agent->counter = 1;
