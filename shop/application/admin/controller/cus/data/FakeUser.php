...
namespace app\admin\controller\cus\data;
...
class FakeUser extends Common
{
    ...
    /**
     * Faq模型对象
     * @var \app\admin\model\cus\data\Express
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\cus\data\FakeUser;
    }
    ...
    public function random()
    {
        ...
        for ($i = 0; $i < $num; $i++) {
            ...
            $fakeUser = new \app\admin\model\cus\data\FakeUser();
