...
use app\admin\model\cus\goods\Comment as CommentModel;
use app\admin\model\cus\data\FakeUser as FakeUserModel;
...
class Comment extends Common
{
    ...
    public function index()
    {
        ...
        $morphs = [
            ...
            'fake_user' => \app\admin\model\cus\data\FakeUser::class
        ];
