...
namespace app\admin\controller\cus\goods;

use app\admin\controller\cus\Common;
use app\admin\model\cus\goods\Goods as GoodsModel;
use app\admin\model\cus\goods\Sku as SkuModel;
use app\admin\model\cus\goods\SkuPrice as SkuPriceModel;
use app\admin\model\cus\goods\StockWarning as StockWarningModel;
use app\admin\model\cus\activity\Activity as ActivityModel;
use app\admin\controller\cus\traits\SkuPrice as SkuPriceTrait;
use addons\cus\traits\StockWarning as StockWarningTrait;
...
class Goods extends Common
{
    ...
    /**
     * 商品模型对象
     * @var \app\admin\model\cus\goods\Goods
     */
