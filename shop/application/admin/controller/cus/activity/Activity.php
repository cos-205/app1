...
namespace app\admin\controller\cus\activity;
...
use addons\cus\library\activity\traits\CheckActivity;
...
class Activity extends Common
{
    ...
    public function index()
    {
        ...
        if (!$this->request->isAjax()) {
            if ($type) {
                return $this->view->fetch('cus/activity/activity/index');
            }

            return $this->view->fetch('cus/activity/activity/activity');
        }
