...
use app\admin\model\cus\Category as CategoryModel;
    ...
    public function detail($id)
    {
        ...
        $categories = $this->model->with(['children' => function ($query) {
            $query->with(['children' => function ($query) {
                $query->removeWhereField('status');
            }])->removeWhereField('status');
        }])->where('parent_id', $category->id)->order('weigh', 'desc')->order('id', 'desc')->select();
