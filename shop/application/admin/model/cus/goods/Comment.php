...
class Comment extends Common
{
    ...
    // 表名
    protected $name = 'cus_goods_comment';
    ...
    {
        return $this->belongsTo(\app\admin\model\cus\goods\Goods::class, 'goods_id', 'id');
    }

    public function order()
    {
        return $this->belongsTo(\app\admin\model\cus\order\Order::class, 'order_id', 'id');
    }


    public function orderItem()
    {
        return $this->belongsTo(\app\admin\model\cus\order\OrderItem::class, 'order_item_id', 'id');
    }
}
