...
namespace app\admin\model\cus\order;
...
use app\admin\model\cus\order\traits\OrderScope;
use app\admin\model\cus\order\traits\OrderStatus;
use app\admin\model\cus\activity\Order as ActivityOrder;

class Order extends Common
{
    use SoftDelete, OrderScope, OrderStatus;

    protected $name = 'cus_order';
    ...
    public function getWechatExtraDataAttr($value, $data)
    {
        ...
        if (strpos(request()->url(), 'addons/cus') !== false && $data['platform'] == 'WechatMiniProgram') {
