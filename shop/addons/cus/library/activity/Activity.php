...
namespace addons\cus\library\activity;

use addons\cus\facade\ActivityRedis;
use addons\cus\library\activity\contract\ActivityInterface;
...
class Activity
{
    ...
    {
        $type = $type ?: $this->type;
        $class = "\\addons\\cus\\library\\activity\\provider\\" . \think\helper\Str::studly($type);
    ...
    public function getter($getter = null) 
    {
        ...
        $class = "\\addons\\cus\\library\\activity\\getter\\" . \think\helper\Str::studly($getter);
        if (class_exists($class)) {
