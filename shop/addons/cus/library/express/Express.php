...
namespace addons\cus\library\express;

use think\exception\HttpResponseException;
use app\admin\model\cus\order\Express as ExpressModel;
...
class Express
{
    ...
    public function provider($driver = null)
    {
        ...
        $class = "\\addons\\cus\\library\\express\\provider\\" . \think\helper\Str::studly($driver);
