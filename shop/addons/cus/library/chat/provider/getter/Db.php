...
namespace addons\cus\library\chat\provider\getter;

use think\helper\Str;
use addons\cus\exception\CusException;
use addons\cus\library\chat\traits\DebugEvent;
use addons\cus\library\chat\Getter;
use addons\cus\controller\traits\UnifiedToken;
use app\admin\model\cus\chat\User as ChatUser;
use app\admin\model\cus\chat\ServiceLog as ChatServiceLog;
use app\admin\model\cus\chat\Record as ChatRecord;
use app\admin\model\cus\chat\CustomerService as ChatCustomerService;
use app\admin\model\cus\chat\CustomerServiceUser as ChatCustomerServiceUser;
use app\admin\model\cus\chat\Question as ChatQuestion;
use app\admin\model\cus\chat\CommonWord as ChatCommonWord;
...
class Db
{
    ...
    public function getModel($type, $model, $is_instance = true)
    {
        ...
        switch($type) {
            case 'auth' :
                if ($model == 'user') {
                    $class = '\\app\\admin\\model\\cus\\user\\' . ucfirst($model);
                } else {
                    $class = '\\app\\admin\\model\\cus\\' . ucfirst($model);
                }
                break;
        }
