...
use addons\cus\library\chat\traits\BindUId;
...
class Chat
{
    ...
    {
        // 实例化相关身份事件
        $class = "\\addons\\cus\\library\\chat\\provider\\auth\\" . ucfirst($auth);
        $provider = new $class($this);
