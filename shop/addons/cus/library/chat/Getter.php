...
namespace addons\cus\library\chat;
...
use addons\cus\library\chat\provider\getter\Db;
use addons\cus\library\chat\provider\getter\Socket;
...
class Getter
{
    ...
    public function provider()
    {
        ...
        $class = "\\addons\\cus\\library\\chat\\provider\\getter\\" . ucfirst($this->driver);
        ...
        throw new CusException('getter 驱动不支持');
    }
