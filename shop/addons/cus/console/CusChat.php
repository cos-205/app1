...
class CusChat extends Command
{
    ...
    protected function configure()
    {
        $this->setName('cus:chat')
            ...
            ->setHelp('此命令是用来启动 Cus商城 的客服服务端进程')
            ->setDescription('Cus商城 客服');
    }
    ...
    private function start($input, $output, $debug)
    {
        ...
        Worker::$logFile = RUNTIME_PATH . 'log/chat/cus_chat.log';
