...
namespace addons\cus\controller\order;
...
use app\admin\model\cus\order\Aftersale as AftersaleModel;
use app\admin\model\cus\order\AftersaleLog as AftersaleLogModel;
