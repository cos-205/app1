...
namespace addons\cus\controller\commission;

use think\Request;
use app\admin\model\cus\goods\Goods as GoodsModel;
use app\admin\model\cus\commission\CommissionGoods;
use addons\cus\service\commission\Goods as CommissionGoodsService;
