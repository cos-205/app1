...
namespace addons\cus\controller\activity;

use addons\cus\controller\Common;
use app\admin\model\cus\activity\Groupon as GrouponModel;
use app\admin\model\cus\activity\GrouponLog as GrouponLogModel;
