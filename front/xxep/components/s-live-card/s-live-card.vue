<template>
  <view>
    ...
    <view v-if="size === 'md'" class="md-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      ...
      <img class="md-img-box" :src="xxep.$url.cdn(data.feeds_img)" referrerpolicy="no-referrer">
    ...
    <view v-if="size === 'sl'" class="sl-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      ...
      <img class="sl-img-box" :src="xxep.$url.cdn(data.feeds_img)" referrerpolicy="no-referrer">
...
const state = reactive({
  liveStatus: {
    101: {
      img: xxep.$url.static('/assets/addons/cus/uniapp/app/mplive/living.png'),
      title: '直播中',
    },
    102: {
      img: xxep.$url.static('/assets/addons/cus/uniapp/app/mplive/start.png'),
      title: '未开始',
    },
    103: {
      img: xxep.$url.static('/assets/addons/cus/uniapp/app/mplive/ended.png'),
      title: '已结束',
    },
  },
});
