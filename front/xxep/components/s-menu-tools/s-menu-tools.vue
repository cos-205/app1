        ...
        <view class="list-item ss-m-b-24" v-for="item in list" :key="item.title">
          <view class="ss-flex-col ss-col-center">
            <button
              ...
              @tap="onClick(item)"
            >
              <image v-if="show" :src="xxep.$url.static(item.icon)" class="list-icon"></image>
            </button>
...
<script setup>
  ...
  const show = computed(() => xxep.$store('modal').menu);

  function onClick(item) {
    closeMenuTools();
    if (item.url) xxep.$router.go(item.url);
  }

  const list = [
    {
      url: '/pages/index/index',
      icon: '/assets/addons/cus/uniapp/tools/home.png',
      title: '首页',
    },
    {
      url: '/pages/index/search',
      icon: '/assets/addons/cus/uniapp/tools/search.png',
      title: '搜索',
    },
    {
      url: '/pages/index/user',
      icon: '/assets/addons/cus/uniapp/tools/user.png',
      title: '个人中心',
    },
    {
      url: '/pages/index/cart',
      icon: '/assets/addons/cus/uniapp/tools/cart.png',
      title: '购物车',
    },
    {
      url: '/pages/user/goods-log',
      icon: '/assets/addons/cus/uniapp/tools/browse.png',
      title: '浏览记录',
    },
    {
      url: '/pages/user/goods-collect',
      icon: '/assets/addons/cus/uniapp/tools/collect.png',
      title: '我的收藏',
    },
    {
      url: '/pages/public/feedback',
      icon: '/assets/addons/cus/uniapp/tools/feedback.png',
      title: '意见反馈',
    },
    {
      url: '/pages/chat/index',
      icon: '/assets/addons/cus/uniapp/tools/service.png',
      title: '客服',
    },
  ];
</script>
