    ...
    <view class="ss-modal-box bg-white ss-flex-col">
      <view class="modal-header ss-flex ss-col-center">
        <view class="header-left ss-m-r-30">
          <image
            class="sku-image"
            :src="xxep.$url.cdn(state.selectedSkuPrice.image || goodsInfo.image)"
            mode="aspectFill"
          >
          </image>
        </view>
            ...
            <view class="tig ss-flex ss-col-center">
              <view class="tig-icon ss-flex ss-col-center ss-row-center">
                <view class="groupon-tag">
                  <image :src="xxep.$url.static('/assets/addons/cus/uniapp/goods/groupon-tag-white.png')">
                  </image>
                </view>
              </view>
...
<script setup>
  ...
  import { formatPrice } from '@/xxep/hooks/useGoods';
  import { isEmpty } from 'lodash';

  const headerBg = xxep.$url.css('/assets/addons/cus/uniapp/goods/groupon-btn-long.png');
  ...
  function onBuy() {
    if (!state.selectedSkuPrice.goods_id) {
      xxep.$helper.toast('请选择规格');
      return;
    }
    if (state.selectedSkuPrice.stock <= 0) {
      xxep.$helper.toast('库存不足');
      return;
    }
