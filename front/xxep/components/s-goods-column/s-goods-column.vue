  ...
  <view class="ss-goods-wrap">
    ...
    >
      <view v-if="tagStyle.show" class="tag-icon-box">
        <image class="tag-icon" :src="xxep.$url.cdn(tagStyle.src)"></image>
      </view>
      <image class="xs-img-box" :src="xxep.$url.cdn(data.image)" mode="aspectFit"></image>
      <view
    ...
    <view v-if="size === 'sm'" class="sm-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      ...
      <image class="sm-img-box" :src="xxep.$url.cdn(data.image)" mode="aspectFill"></image>
    ...
    >
      ...
      <image class="lg-img-box" :src="xxep.$url.cdn(data.image)" mode="aspectFill"></image>
    ...
    <view v-if="size === 'sl'" class="sl-goods-card ss-flex-col" :style="[elStyles]" @tap="onClick">
      ...
      <image class="sl-img-box" :src="xxep.$url.cdn(data.image)" mode="aspectFill"></image>
...
<script setup>
  ...
  import { formatSales } from '@/xxep/hooks/useGoods';
  import { formatStock } from '@/xxep/hooks/useGoods';
